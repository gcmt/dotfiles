 ...
 */
char font[] = "Noto Sans Mono:pixelsize=13:antialias=true:autohint=true";
int borderpx = 5;

/* Requires 'st-disable-bold-italic-fonts' patch */
int disablebold = 1;
int disableitalic = 1;
int disableroman = 1;
...
MouseShortcut mshortcuts[] = {
	...
	/* Requires 'st-scrollback-mouse' patch */
