...
vnoremap <silent> aa :<c-u>call objects#list#item('(', 0)<cr>
onoremap <silent> aa :<c-u>norm vaa<cr>
vnoremap <silent> ia :<c-u>call objects#list#item('(', 1)<cr>
...
vnoremap <silent> ak :<c-u>call objects#list#item('{', 0)<cr>
onoremap <silent> ak :<c-u>norm vak<cr>
vnoremap <silent> ik :<c-u>call objects#list#item('{', 1)<cr>
